<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['guide:evaluation:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['guide:evaluation:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['guide:evaluation:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['guide:evaluation:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="evaluationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评价时间" align="center" prop="evalTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.evalTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
...
<script>
import { listEvaluation, getEvaluation, delEvaluation, addEvaluation, updateEvaluation } from "@/api/guide/evaluation"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除游客评价编号为"' + evalIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('guide/evaluation/export', {
        ...this.queryParams
