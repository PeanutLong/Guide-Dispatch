<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="集合点名称" prop="pointName">
        <el-input
          v-model="queryParams.pointName"
          placeholder="请输入集合点名称"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="编号" prop="pointCode">
        <el-input
      ...
      <el-form-item label="具体位置描述" prop="location">
        <el-input
    ...
    <el-table v-loading="loading" :data="pointList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="集合点名称" align="center" prop="pointName" />
      <el-table-column label="编号" align="center" prop="pointCode" />
      <el-table-column label="具体位置描述" align="center" prop="location" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="集合点名称" prop="pointName">
          <el-input v-model="form.pointName" placeholder="请输入集合点名称" />
        </el-form-item>
        <el-form-item label="编号" prop="pointCode">
          <el-input v-model="form.pointCode" placeholder="请输入编号" />
        </el-form-item>
        <el-form-item label="具体位置描述" prop="location">
...
<script>
import { listPoint, getPoint, delPoint, addPoint, updatePoint } from "@/api/guide/point"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        pointName: [
          { required: true, message: "集合点名称不能为空", trigger: "blur" }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除集合点编号为"' + pointIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('guide/point/export', {
        ...this.queryParams
