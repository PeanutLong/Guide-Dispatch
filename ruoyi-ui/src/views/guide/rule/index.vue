    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="规则值" prop="ruleValue">
          <el-input v-model="form.ruleValue" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="优先级" prop="priority">
...
<script>
import { listRule, getRule, delRule, addRule, updateRule } from "@/api/guide/rule"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除负载均衡规则配置编号为"' + ruleIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('guide/rule/export', {
        ...this.queryParams
